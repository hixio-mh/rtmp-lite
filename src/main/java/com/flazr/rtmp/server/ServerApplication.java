...
public class ServerApplication {
    ...
    public ServerApplication(final String rawName,File directory) {
    ...
    public RtmpReader getReader(final String rawName) {
        ...
        try {
            if(streamName.startsWith("mp4:")) {
                ...
                return new F4vReader(directory.getPath() + "/" + readerPlayName);
            } else {                
    ...
    public static ServerApplication get(final String rawName, File directory) {
        final String appName = cleanName(rawName);
        ServerApplication app = RtmpServer.APPLICATIONS.get(appName);
        if(app == null) {
            app = new ServerApplication(appName, directory);
